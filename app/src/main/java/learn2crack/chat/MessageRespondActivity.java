 ...
 */
public class MessageRespondActivity extends FragmentActivity implements  ActionBar.TabListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                new Send().execute();
                Toast.makeText(MessageRespondActivity.this,"send  is clicked!", Toast.LENGTH_SHORT).show();
