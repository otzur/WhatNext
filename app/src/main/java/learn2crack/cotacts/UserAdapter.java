...
/**
 * Created by samzaleg on 5/27/2015.
 */
public class UserAdapter extends BaseAdapter implements Filterable {
     ...
     */
    public UserAdapter(Context context, List<? extends Map<String, ?>> data,
            ...
            if (v != null) {
                ...
                if (!bound) {
                    if (v instanceof Checkable) {
                        ...
                        if(data instanceof String && (data.equals("true") || data.equals("false"))){
                            if(data.equals("true")){
